...
In figure \ref{fig:D1spread} \textbf{a)} and \textbf{b)}, the amount of infected individuals $j_n$ is plotted for times $t_1=$, $t_2 = $. Subfigure \textbf{c)} shows arrival times for all countries.
...
\begin{figure}
    ...
    \caption{Spread of an edpidemic originating from South Africa (marked with a white cross) on a network of countries connected by airlines. The figures \textbf{a)}, \textbf{b)} and \textbf{c)} show the time development of the percentage of infected individuals (color code: red - high infection, blue - low infection} as snapshots for $t=\SI{50}{d}, t=\SI{100}{d}$ and $t=\SI{}{d}$.
