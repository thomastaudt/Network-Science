...
plot folder . '31_infty.dat' u ($1*1e3):3 w lp pt 7 ps 0.5 t '$\mathrm{max}_C$', \
     folder . '31_infty.dat' u ($1*1e3):5 w lp pt 7 ps 0.5 t '$\langle s\rangle$', \
...
plot folder . '31_infty.dat' u ($1*1e3):4 w lp pt 7 ps 0.5 t '$\mathrm{max}_C^\mathrm{f}$', \
     folder . '31_infty.dat' u ($1*1e3):6 w lp pt 7 ps 0.5 t '$\langle s\rangle^\mathrm{f}$', \
